...
def upload_file():
    t = time.time()
    upload_url = '/Users/zhangzhihao/Documents/webbrain/uploads/upload' + str(t) + '.mp4'
    html_url = '/uploads/upload' + str(t) + '.mp4'
    ffmpeg_4 = ' -y ' + upload_url
    html = render_template('index.html')
    video_html = render_template('video.html', src=html_url)
